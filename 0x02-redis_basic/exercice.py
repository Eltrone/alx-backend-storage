...
class Cache:
    ...
    def __init__(self):
        """
        Initialisation client Redis et nettoyage de la base de données.
        """
    ...
    def store(self, data: Union[str, bytes, int, float]) -> str:
        """
        Stocke les données dans Redis en utilisant clé aléatoire.
    ...
    def get(self, key: str, fn: Callable = None) -> Union[str, bytes, int, float]:
        """
        Récupère une valeur de Redis et convertit si nécessaire.
...
def count_calls(method: Callable) -> Callable:
    """
    Décorateur compte+stocke le nombre de fois la méthode est appelée.
    """
